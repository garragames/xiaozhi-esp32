...
#define AUDIO_CODEC_I2C_SCL_PIN  GPIO_NUM_0 // COMPARTIDO
...
#define LCD_SCLK_PIN            GPIO_NUM_0  // COMPARTIDO
#define LCD_CS_PIN              GPIO_NUM_20
#define LCD_DC_PIN              GPIO_NUM_1
#define LCD_RST_PIN             GPIO_NUM_NC // Reset Soft
#define LCD_BL_PIN              GPIO_NUM_NC // Hardware
